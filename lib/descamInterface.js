...
module.exports = {
  ...
  pluginAction(subcommand) {
    return new Promise((resolve, reject) => {
      ...
      if (utilities.checkDescamPath(DESCAMPATH)) {
      } else if (utilities.checkEnvVar()) {
          ...
          if (utilities.checkGrammar(lang)) {
            ...
            if ((filePath !== null || filePath !== undefined)) {
              ...
              if (subcommand !== "h") {
                ...
                cmd = `${DESCAMPATH}/SCAM -f ${filePath} -o ${descamMain.outputPath}/DESCAM_OUTPUT  -${subcommand}`;
              } else {
  ...
  async lint(filePath) {
    ...
    lintMessages = [{
      severity: 'info',
      excerpt: 'this is a test message from the descam package',
